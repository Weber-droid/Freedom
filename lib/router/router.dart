...
Route<dynamic> onGenerateRoute(RouteSettings settings) {
  ...
  switch (settings.name) {
    case SplashPage.routeName:
      return _pageBuilder((context) => const SplashPage(), settings: settings);
    ...
    case LoginView.routeName:
      return _pageBuilder((context) => const LoginView(), settings: settings);
    ...
    case MessageDriverScreen.routeName:
      return _pageBuilder(
        (context) => const MessageDriverScreen(),
        settings: settings,
      );
    default:
      return _pageBuilder((context) => const ErrorPage(), settings: settings);
  }
}
