...
class _$ArticleModelImpl implements _ArticleModel {
  ...
  @override
  String toString() {
    return 'ArticleModel(title: $title, description: $description, url: $url, urlToImage: $urlToImage, publishedAt: $publishedAt, content: $content, author: $author)';
  }
...
abstract class _ArticleModel implements ArticleModel {
  const factory _ArticleModel(
      ...
      required final String author}) = _$ArticleModelImpl;
