...
class ShowRiderSearch<T extends StateStreamable<S>, S> extends StatelessWidget {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      return BlocConsumer<T, S>(
        ...
        buildWhen: (previous, current) =>
            searchTimeElapsedSelector(previous) != searchTimeElapsedSelector(current) ||
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: BlocBuilder<T, S>(
                          builder: (context, state) {
                            final cancellationStatus = cancellationStatusSelector(state);
                            final isCanceling = cancellationStatus.toString().contains('canceling');
  ...
  String _getFareText(dynamic rideData) {
    ...
    // Handle different data structures
    if (rideData is Map) {
      final fare = rideData['fare']?.toString() ?? rideData['price']?.toString() ?? '';
