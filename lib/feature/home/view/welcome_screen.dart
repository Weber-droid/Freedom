...
class SmartPickupLocationWidget extends StatefulWidget {
  ...
  @override
  _SmartPickupLocationWidgetState createState() => _SmartPickupLocationWidgetState();
}
                ...
                children: [
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: widget.isPickUpLocation || widget.isInitialDestinationField
                          ? _isLoading
                          ? Container(
                        width: 24,
                        height: 24,
                        ...
                        child: CircularProgressIndicator(
                          strokeWidth: 2,
                          valueColor: AlwaysStoppedAnimation<Color>(widget.iconBaseColor),
                        ),
                      )
